...
rules, and reachable provenance for every fact.

**Status:** research/design phase. Start with [docs/architecture.md](docs/architecture.md);
the evidence behind it is in [docs/research/](docs/research/2026-07-02/README.md).
